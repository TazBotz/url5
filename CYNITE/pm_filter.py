...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.edit_message_text(text=f"<s>{query.message.text}</s>",
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="✅️ Uᴘʟᴏᴀᴅᴇᴅ ✅️", callback_data="doneupld")],[InlineKeyboardButton(text="Gᴏ ᴛᴏ Mᴇꜱꜱᴀɢᴇ", url=f"{query.message.link}")]])
        )
        ...
        await query.edit_message_text(text=f"<s>{query.message.text}</s>",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⚠️ Uɴᴀᴠᴀɪʟᴀʙʟᴇ ⚠️", callback_data="notavl")],[InlineKeyboardButton(text="Gᴏ ᴛᴏ Mᴇꜱꜱᴀɢᴇ", url=f"{query.message.link}")]])
        )
        ...
        await query.edit_message_text(text=f"<s>{query.message.text}</s>",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="❌ Rᴇᴊᴇᴄᴛᴇᴅ ❌", callback_data="rjctreq")],[InlineKeyboardButton(text="Gᴏ ᴛᴏ Mᴇꜱꜱᴀɢᴇ", url=f"{query.message.link}")]])
        )
        ...
        await query.edit_message_text(text=f"<s>{query.message.text}</s>",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="♻️ Aʟʀᴇᴀᴅʏ Aᴠᴀɪʟᴀʙʟᴇ ♻️", callback_data="donealrd")],[InlineKeyboardButton(text="Gᴏ ᴛᴏ Mᴇꜱꜱᴀɢᴇ", url=f"{query.message.link}")]])
        )
